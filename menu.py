    ...
    if menu_category.isdigit():
        ...
        if int(menu_category) in menu_items.keys():
            ...
            # 2. Ask customer to input menu item number
                    menu_selection = input("Select an item number from the menu: ")
            ...
            # 3. Check if the customer typed a number
                ...
                # Convert the menu selection to an integer
                            ...
                            print(f"{menu_selection} is not an item on the menu.")

                # 4. Check if the menu selection is in the menu items
                        if menu_selection in menu_items:

                    # Store the item name as a variable
                            menu_choice = menu_items [menu_selection]

                    # Ask the customer for the quantity of the menu item
                        quantity = input(f"How many {menu_choice} do you want?")

                    # Check if the quantity is a number, default to 1 if not
                        if quantity.isdigit():
                            quantity = int(quantity)
                        else:
                            print("The input is not a number, so defaulting to 1.")
                            quantity = 1
                ...
                print("Your choice is not a menu option.")
        else:
            # Tell the customer they didn't select a menu option
...
for item in order:
    ...
    num_quantity_spaces = 10 - len(quantity)
...
# and print the prices.
    ...
    print(f"The total price for your order is ${total_price:.2f}")